      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link to="/" className="inline-block" aria-label="Cruip">
                  <img className='h-16 fill-current text-purple-600' src='logo-inno.png' alt='logo'/>
                </Link>
              </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Text1</h6>
                <ul>
                  <li className="mb-1">
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Text2</h6>
                <ul>
                  <li className="mb-1">
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Text3</h6>
                <ul>
                  <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Ovidius Innovation Center All rights reserved.</div>
